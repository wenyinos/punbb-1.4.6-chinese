...
// Pixel theme CSS (PunBB → Bootstrap 5 bridge)
$forum_loader->add_css($base_url.'/style/Pixel/Pixel.min.css', array('type' => 'url', 'weight' => 100, 'group' => FORUM_CSS_GROUP_DEFAULT));
